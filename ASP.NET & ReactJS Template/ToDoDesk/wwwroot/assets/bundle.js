...
var ToDoListApp = function (_Component) {
    _inherits(ToDoListApp, _Component);
    ...
    function ToDoListApp(props) {
        ...
        _this.changeTaskDone = _this.changeTaskDone.bind(_this);
        _this.addNewTask = _this.addNewTask.bind(_this);
        _this.delTask = _this.delTask.bind(_this);
        _this.state = { tasks: taskArr };
        return _this;
    }
    ...
    _createClass(ToDoListApp, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(NewTask, { addNewTask: this.addNewTask }),
                _react2.default.createElement(TaskList, { tasks: this.state.tasks, changeTaskDone: this.changeTaskDone, delTask: this.delTask })
            );
        }
    }, {
        key: 'changeTaskDone',
        value: function changeTaskDone(text) {
            var newArr = this.state.tasks.map(function (x) {
                if (x.text !== text) return x;x.done = !x.done;return x;
            });
            this.setState({ tasks: newArr });
        }
    }, {
        key: 'addNewTask',
        value: function addNewTask(text) {
            var newArr = this.state.tasks;
            newArr.push({ id: new Date(), text: text, done: false }); //Изменяет сам массив, не образует копии
            this.setState({ tasks: newArr });
        }
    }, {
        key: 'delTask',
        value: function delTask(text) {
            var newArr = this.state.tasks;
            newArr.splice(newArr.findIndex(function (x) {
                return x.text === text;
            }), 1); //filter  фильтрует но не setState tasks не изменяет
            this.setState({ tasks: newArr });
        }
    }]);
...
var NewTask = function (_Component2) {
    _inherits(NewTask, _Component2);

    function NewTask(props) {
        _classCallCheck(this, NewTask);

        var _this2 = _possibleConstructorReturn(this, (NewTask.__proto__ || Object.getPrototypeOf(NewTask)).call(this, props));

        _this2.handleTyping = _this2.handleTyping.bind(_this2);
        _this2.addNewTask = _this2.addNewTask.bind(_this2);
        _this2.state = { typed: '' };
        return _this2;
    }
    ...
    _createClass(NewTask, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement('input', { ref: 'field', onChange: this.handleTyping, type: 'text', className: 'newTaskInput', placeholder: text }),
                _react2.default.createElement(
                    'button',
                    { onClick: this.addNewTask, className: 'newTaskButton' },
                    '+Add'
                )
            );
        }
...
var TaskList = function (_Component3) {
    ...
    function TaskList(props) {
        ...
        var _this3 = _possibleConstructorReturn(this, (TaskList.__proto__ || Object.getPrototypeOf(TaskList)).call(this, props));

        _this3.handleClick = _this3.handleClick.bind(_this3);
        _this3.delTask = _this3.delTask.bind(_this3);
        return _this3;
    }
    ...
    _createClass(TaskList, [{
        ...
        value: function render() {
            ...
            var tasks = this.props.tasks.map(function (x) {
                return _react2.default.createElement(
                    'div',
                    { key: x.id, onClick: _this4.handleClick, className: 'row' },
                    _react2.default.createElement(
                        'div',
                        { className: 'col-xs-9 taskField' },
                        _react2.default.createElement(Task, { text: x.text, done: x.done })
                    ),
                    _react2.default.createElement(
                        'div',
                        ...
                        _react2.default.createElement(
                            'button',
                            { id: x.text, onClick: _this4.delTask, className: 'taskButton' },
                            'X'
                        )
                    )
                );
        ...
        value: function handleClick(event) {
            if (event.target.childNodes[0].nodeValue != null) {
                var text = event.target.childNodes[0].nodeValue.toString();
